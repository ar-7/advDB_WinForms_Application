...
{
    public partial class StaffFunctions : Form
    {
        ...
        // Function that runs when the hotel description save button is clicked.
        ...
        private void StaffFunctions_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void backButton_Click(object sender, EventArgs e)
        {
            ...
            StaffMenu adminmenu = new StaffMenu();
        ...
        {
            room_bookingDataGridView.Rows[e.RowIndex].ErrorText = e.Exception.Message;
            e.Cancel = true;
        }
